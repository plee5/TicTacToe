...
public class TicGUI extends JFrame 
{
    ...
    private void initialize()             //Initialize tic tac toe game board
    {
        ...
        //want this for the 2d game.
        JLabel lab = new JLabel("TEST", SwingConstants.CENTER);
        lab.setText("First choose a grid.");
    ...
    {      //Implementing action listener for buttons
        ...
        public void actionPerformed(ActionEvent a) 
        {
            ...
            //reset the board and have the user play a spot. 
            //Have text saying which corner they are currently playing
            if (twoD == true) {
